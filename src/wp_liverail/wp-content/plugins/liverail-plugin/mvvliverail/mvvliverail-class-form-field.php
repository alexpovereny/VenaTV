...
class MVVLIVERAIL_Form_Field {
    ...
    public function __construct($name, $settings = array()) {
        ...
        $this->validation = array("MVVLIVERAIL_Form_Field", "dummy_validation");
        ...
        if ( !isset($this->value) ) {
            $this->value = get_option(MVVLIVERAIL . $this->name);
        }
    }
    ...
    public function save() {
        update_option(MVVLIVERAIL . $this->name, $this->value);
    }
...
class MVVLIVERAIL_Form_Field_Uneditable extends MVVLIVERAIL_Form_Field {
...
class MVVLIVERAIL_Form_Field_Select extends MVVLIVERAIL_Form_Field {
...
class MVVLIVERAIL_Form_Field_Radio extends MVVLIVERAIL_Form_Field {
...
class MVVLIVERAIL_Form_Field_Toggle extends MVVLIVERAIL_Form_Field {
