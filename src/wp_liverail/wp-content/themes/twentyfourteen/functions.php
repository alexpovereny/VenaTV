...
//add_role('custom_reporting_dashboard','Network side',array('network_side'));
//if( current_user_can('network_side')){
// let them manage those network_side!   
//}
//
...
if (current_user_can('liverail_reporting_and_dashboard')) {
    require get_template_directory() . '/liverail/reporting-dashboard.php';
}

if (current_user_can('liverail_support_and_ticketing')) {
    require get_template_directory() . '/liverail/support-ticketing.php';
}
